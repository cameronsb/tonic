...
export function MusicProvider({ children }: MusicProviderProps) {
    const { settings, setMasterVolume, setShowInScaleColors, setKeyboardPreviewEnabled, setScaleViewEnabled } = useSettings();
    ...
    const { playNote: rawPlayNote, playChord: rawPlayChord, setMasterVolume: setAudioMasterVolume, loading, audioContext, instrument } = useAudioEngine();
